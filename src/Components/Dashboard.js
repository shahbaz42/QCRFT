          ...
          <main className="flex-1">
            <div className="py-6">
              <div className="max-w-2xl mx-auto px-4 sm:px-6 md:px-8">
                <h1 className="text-md absolute top-0 p-2 drop-shadow-md rounded-2xl bg-white font-semibold text-gray-600">Asynchronous Programming in Javascript.</h1>
              </div>
              <div className="max-w-2xl mx-auto px-4 sm:px-6 md:px-8">
                {/* Replace with your content */}
                <Draggable>
                    <div className="py-4" style={{position:"relative", zIndex:1}}>
                        <CardWithHeader header="Qn 1 : What is the purpose of using templates with a vector?" options={["Vectors have dynamic sizes", "Vectors are faster than arrays", "Vectors can store custom types", "All of the above" ]} />
                        <CardWithHeader header="Qn 1 : What is the purpose of using templates with a vector?" options={["Vectors have dynamic sizes", "Vectors are faster than arrays", "Vectors can store custom types", "All of the above" ]} />
